...
import {
  ...
  Lightbulb, VideoCamera, X, CheckCircle,
...
const mockHistory = [
  ...
  { id: 'h4', title: '春节营销活动文案', status: 'expired' as const, time: '2024-12-01 10:00', result: '春节促销活动文案（超过30天已失效）', resultId: '' },
  { id: 'h5', title: '双十一促销脚本', status: 'expired' as const, time: '2024-11-15 14:30', result: '双十一购物节推广文案（超过30天已失效）', resultId: '' },
]
