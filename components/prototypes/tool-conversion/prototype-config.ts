...
export const scenes: Scene[] = [
  { id: 'douyin-cover', name: '抖音/视频号封面', description: '竖屏视频封面', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-08-result.jpg', ratio: '1080 x 1920', previewImage: '/prototype-assets/chinaz-scene-08-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'redbook-cover', name: '小红书封面', description: '竖版内容封面', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-06-result.jpg', ratio: '1242 x 1660', previewImage: '/prototype-assets/chinaz-scene-06-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'phone-wallpaper', name: '手机壁纸', description: '手机屏幕壁纸', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-23-result.jpg', ratio: '1080 x 1920', previewImage: '/prototype-assets/chinaz-scene-23-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'poster-background', name: '海报背景', description: '宣传海报背景', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-21-result.jpg', ratio: '1200 x 1600', previewImage: '/prototype-assets/chinaz-scene-21-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  ...
  { id: 'redbook-post', name: '小红书配图', description: '信息流竖版配图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-07-result.jpg', ratio: '1080 x 1350', previewImage: '/prototype-assets/chinaz-scene-07-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'video-cover', name: '横版视频封面', description: '横版视频缩略图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-09-result.jpg', ratio: '1280 x 720', previewImage: '/prototype-assets/chinaz-scene-09-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  ...
  { id: 'portrait-poster', name: '竖版宣传图', description: '竖版宣传海报', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-22-result.jpg', ratio: '1080 x 1350', previewImage: '/prototype-assets/chinaz-scene-22-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'common-portrait', name: '普通竖版图', description: '封面长图入口', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-05-result.jpg', ratio: '1200 x 1600', previewImage: '/prototype-assets/chinaz-scene-05-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  ...
  { id: 'social-vertical', name: '社媒竖图', description: '信息流竖版配图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-11-result.jpg', ratio: '1080 x 1350', previewImage: '/prototype-assets/chinaz-scene-11-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'social-square', name: '社媒方图', description: '朋友圈通用方图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-10-result.jpg', ratio: '1200 x 1200', previewImage: '/prototype-assets/chinaz-scene-10-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'social-horizontal', name: '社媒横图', description: '横版信息流配图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-12-result.jpg', ratio: '1350 x 1080', previewImage: '/prototype-assets/chinaz-scene-12-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  ...
  { id: 'product-scene', name: '商品场景图', description: '商品场景展示图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-16-result.jpg', ratio: '1600 x 1200', previewImage: '/prototype-assets/chinaz-scene-16-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'product-main', name: '商品主图', description: '电商商品主图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-13-result.jpg', ratio: '1200 x 1200', previewImage: '/prototype-assets/chinaz-scene-13-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'product-portrait', name: '商品竖图', description: '商品竖版展示图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-14-result.jpg', ratio: '1200 x 1500', previewImage: '/prototype-assets/chinaz-scene-14-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'product-landscape', name: '商品横图', description: '商品横版展示图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-15-result.jpg', ratio: '1600 x 900', previewImage: '/prototype-assets/chinaz-scene-15-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'store-banner', name: '店铺横幅', description: '店铺首页横幅', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-17-result.jpg', ratio: '1920 x 1080', previewImage: '/prototype-assets/chinaz-scene-17-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'ppt-background', name: 'PPT 背景', description: '演示文稿背景', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-18-result.jpg', ratio: '1920 x 1080', previewImage: '/prototype-assets/chinaz-scene-18-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
  { id: 'report-cover', name: '汇报封面', description: '汇报文档封面', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-19-result.jpg', ratio: '1920 x 1080', previewImage: '/prototype-assets/chinaz-scene-19-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
