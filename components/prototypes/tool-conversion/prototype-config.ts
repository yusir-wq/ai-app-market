...
export const scenes: Scene[] = [
  ...
  { id: 'redbook-post', name: '小红书配图', description: '信息流竖版图', image: expansionSourceImage, result: '/prototype-assets/chinaz-scene-07-result.jpg', ratio: '1080 x 1350', previewImage: '/prototype-assets/chinaz-scene-07-result.jpg', hoverImage: expansionSourceImage, interaction: 'expand' },
